        ...
        <div className="w-full md:w-72 flex-shrink-0 space-y-4">
          <div className="bg-white border border-hairline rounded-lg p-6 text-center">
            <div className="relative inline-block mb-4">
              ...
              <button className="absolute bottom-0 right-0 w-7 h-7 bg-black text-white rounded-full flex items-center justify-center">
                <Camera size={12} />
              </button>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                {mockBadges.map(badge => {
                  ...
                  return (
                    <div key={badge.id} className={`rounded-lg p-4 text-center border transition-all ${earned ? 'border-black bg-white' : 'border-hairline bg-surface-soft opacity-50'}`}>
          ...
          {activeTab === 'achievements' && (
            <div className="space-y-3">
              {[
                ...
                <div key={a.title} className={`flex items-center gap-4 bg-white border rounded-lg p-4 ${a.done ? 'border-semantic-success/30' : 'border-hairline opacity-60'}`}>
