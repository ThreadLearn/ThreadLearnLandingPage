...
import { fadeInDown, fadeInUp, fadeInLeft, popIn } from '../../lib/animations'
  ...
  return (
    <PageWrapper>
      <div className="max-w-content mx-auto px-6 py-8">
        {/* Header */}
        <AnimatedSection variants={fadeInDown} className="flex items-start justify-between mb-8">
          <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div>
              ...
              <AnimatedGroup stagger={0.08} className="space-y-3">
                {enrolledCourses.map(course => {
                  const prog = mockProgress[course.id]
                  return (
                    <AnimatedItem key={course.id} variants={fadeInUp}>
                      <motion.div
          ...
          <div className="space-y-5">
            ...
            {/* Streak */}
            <AnimatedSection variants={fadeInLeft} delay={0.15}>
              <div className="bg-white border border-hairline rounded-lg p-5">
            ...
            {/* Badges */}
            <AnimatedSection variants={fadeInLeft} delay={0.2}>
              <div className="bg-white border border-hairline rounded-lg p-5">
                <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex gap-2 flex-wrap">
                  {userBadges.map(b => (
                    <motion.div
                      key={b.id}
                      className={`w-10 h-10 rounded-full bg-block-${b.color.replace('block-', '')} flex items-center justify-center text-xl`}
                      title={b.name}
            ...
            <AnimatedSection variants={fadeInLeft} delay={0.25}>
              <div className="bg-white border border-hairline rounded-lg p-5">
                <div className="flex items-center gap-2 mb-3">
                  <Trophy size={16} />
            ...
            {unreadNotifs.length > 0 && (
              <AnimatedSection variants={fadeInLeft} delay={0.3}>
