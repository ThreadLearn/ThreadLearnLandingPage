    ...
    <div className="min-h-screen">
      ...
      <section className="bg-block-navy text-white py-24 px-6">
        <div className="max-w-content mx-auto">
          ...
          <div className="flex gap-3 flex-wrap">
            <Link to="/courses"><Button variant="primary" className="bg-white text-black hover:bg-white/90">Explore courses <ArrowRight size={15} className="inline ml-1" /></Button></Link>
            <Link to="/contact"><Button variant="ghost" className="border border-white/30 text-white hover:bg-white/10">Get in touch</Button></Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-content mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {values.map(v => (
              <div key={v.title} className="border border-hairline rounded-xl p-6 flex gap-4">
      ...
      <section className="bg-surface-soft py-20 px-6">
        <div className="max-w-content mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {team.map(member => (
              <div key={member.name} className="bg-white border border-hairline rounded-xl p-6">
      ...
      <section className="bg-block-lilac py-16 px-6 text-center">
        <div className="max-w-content mx-auto">
          ...
          <Link to="/register"><Button size="lg">Get started free <ArrowRight size={15} className="inline ml-1" /></Button></Link>
        </div>
      </section>
    </div>
  )
